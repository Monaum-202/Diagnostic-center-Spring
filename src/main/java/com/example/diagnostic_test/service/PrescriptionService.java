...
//    }
    ...
    public Page<PrescriptionDTO> getAllPrescriptions(Pageable pageable) {
        // Fetch paginated Prescription entities from the repository
        Page<Prescription> prescriptionPage = prescriptionRepository.findAll(pageable);

        // Convert the Page of Prescription entities to a Page of PrescriptionDTOs
        return prescriptionPage.map(PrescriptionMapper::toDTO);
    }
