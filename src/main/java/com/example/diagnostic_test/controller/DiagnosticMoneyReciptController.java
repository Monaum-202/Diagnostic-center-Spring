...
//    }
    ...
    @GetMapping
    public Page<DiagnosticMoneyReceipt> getAllDiagnosticMoneyReceipts(Pageable pageable) {
        return diagnosticMoneyReceiptService.getAllDiagnosticMoneyReceipts(pageable);
    }
